...
| Beaches      | Conditon was determined from a 2018 report on the global erosion rates (% of affected beaches by erosion rate * number of years assessment), and scaled from 0-1.        | Sandy beach extent per oceanic region (vector based)| Sandy beach trend was calculated from changes in coastal area (km2) from 2010 to 2020, multiplied by year's since assessment, and applied to each country's area. Trend was rescaled to 0-1.                                                                                                            |
