...
(previously: r child = '../../metadata_documentation/ohi_model/trend.Rmd', eval=trend)
...
**Table 5.2. Pressure matrix** Rank sensitivity of each goal (or, goal element) to each stressor. \# make better looking!!!

```{r pressure matrix, echo=FALSE}

pressure_matrix <- read.csv("https://raw.githubusercontent.com/OHI-Science/ohi-global/76634d93f7fbc2470a2144793d15924d55f552ff/eez/conf/pressures_matrix.csv", na.strings=c("","NA"), stringsAsFactors = FALSE) %>%
...
(previously: r child = '../../metadata_documentation/ohi_model/resilience.Rmd', eval=resilience)
