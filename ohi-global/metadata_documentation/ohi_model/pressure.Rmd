...
full_lyr_names <- read.csv(here("ohi-global/metadata_documentation/layers_eez_base.csv")) %>% 
  select(layer, name, description)

pressure_cat <- read.csv(here("ohi-global/eez/conf/pressure_categories.csv")) %>% 
