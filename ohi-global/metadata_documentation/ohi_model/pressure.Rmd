...
full_lyr_names <- read_csv(here("ohi-global/metadata_documentation/layers_eez_base.csv")) %>% 
  select(layer, name, description)

pressure_cat <- read_csv(here("ohi-global/eez/conf/pressure_categories.csv")) %>% 
...
pressure_matrix <- read.csv(here("ohi-global/eez/conf/pressures_matrix.csv"), na.strings=c("","NA"), stringsAsFactors = FALSE) %>%
